...
export class Command {
    ...
    cb = (query, res) => { // arrow function to get around this/that fuckery
        try {
            const input = new Input(query, res, this.args);
