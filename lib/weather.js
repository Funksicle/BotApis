...
export const jackieWeather = new Route("/jackieweather", async function (req, res) {
    try {
        ...
        const temperature = `At ${time} in ${location}, it was ${json.current.temperature_2m}${json.current_units.temperature_2m} (${celsiusToFahrenheit(json.current.temperature_2m)}°F), `;
